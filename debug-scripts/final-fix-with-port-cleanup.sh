...
echo "🔧 Final fix with port cleanup..."

# Stop the service first
echo "🛑 Stopping service..."
sudo systemctl stop us-calendar

# Kill ALL existing Python processes that might be using port 5001
...
cd /opt/us-calendar
chmod +x debug-scripts/test-email-angel.sh
./debug-scripts/test-email-angel.sh
